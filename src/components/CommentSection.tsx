...
const countComments = (comments: Comment[]): number => comments.reduce((total, comment) => total + 1 + (comment.replies ? countComments(comment.replies) : 0), 0);
          ...
          <div className="flex items-center gap-2 mt-2 ml-2">
            <Button
              ...
              className={`h-7 px-2 rounded-full text-xs transition-all duration-300 ${
                comment.isLiked
                  ? '!bg-blog-like-bg !text-blog-like hover:!bg-blog-like-bg hover:!text-blog-like focus:!text-blog-like active:!text-blog-like'
